...
export const imports: ImportListItem[] = [
  {
    id: "imp_001",
    sourceType: "arquivo",
    company: "Conecta Sul",
...
export const reconciliations: ReconciliationListItem[] = [
  {
    id: "rec_001",
...
export const operators: OperatorListItem[] = [
  { id: "op_01", name: "Vivo", code: "VIVO", status: "ativa", reconciliationRate: 84 },
  { id: "op_02", name: "Claro", code: "CLARO", status: "ativa", reconciliationRate: 76 },
  { id: "op_03", name: "Tim", code: "TIM", status: "ativa", reconciliationRate: 71 }
];

export const sellers: SellerListItem[] = [
  {
    id: "sel_01",
